...
def proposal_layer(rpn_cls_prob, rpn_bbox_pred, im_info, mode, _feat_stride, anchors, num_anchors, cfg):
  """A simplified version compared to fast/er RCNN
     For details please see the technical report
  """
  if mode == "TRAIN":
    pre_nms_topN = cfg.TRAIN_BATCH_DET_RPN_PRE_NMS_TOP_N
...
def proposal_layer_tf(rpn_cls_prob, rpn_bbox_pred, im_info, mode, _feat_stride, anchors, num_anchors, cfg):
